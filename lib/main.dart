...
void main() {
  runApp(const MyCounterInheritedWidget(child: MyApp()));
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  @override
  Widget build(BuildContext context) {
    //final counter = MyCounterInheritedWidget.of(context).counter;
    //final increment = MyCounterInheritedWidget.of(context).increment();
      ...
      child: Scaffold(
        ...
        body: Center(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                MyCounterInheritedWidget.of(context)!.counter.toString(),
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            ...
            MyCounterInheritedWidget.of(context)!.increment();
          },
          tooltip: 'Increment',
